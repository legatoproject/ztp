...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "YOUR_ATS_ENDPOINT" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_CERTIFICATE_FILENAME   "aws_iot_cert.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "aws_iot_key.key" ///< Device private key filename
// =================================================
